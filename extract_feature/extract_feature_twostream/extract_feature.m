...
addpath('../twostreamfusion/matconvnet/matlab/+dagnn/@DagNN')
run vl_setupnn

%%%%%%%%%%%%%%%%%%%%%%%%  setup here %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% only need to setup these 4 parameters
%/home/wh/code/Anomaly_Detection/dataset/anomaly_detection/ped1/training/224/features/twostream_res152_7x7这一串文件夹要先手动建
%否则在创建h5文件时会出错
root = '../../';
